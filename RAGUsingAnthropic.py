...
class LlmFacade:
    ...
    def invoke_anthropic_cloud_llm(self, prompt: str) -> str:
        # print("Inside invoke_anthropic_cloud_llm...")
        messages = [{"role": "user", "content": [{"text": prompt}]}]
        # print("Inside invoke_anthropic_cloud_llm...2")
        ...
        # print("Inside invoke_anthropic_cloud_llm...3")
        # print("Inside invoke_anthropic_cloud_llm...2", response.content[0].text)
